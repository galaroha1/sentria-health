...
import { Check, X, ArrowRight, TrendingDown, AlertTriangle, Users } from 'lucide-react';
                            ...
                            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        {proposal.affectedPatientCount && proposal.affectedPatientCount > 0 && (
                                            <span className="ml-2 inline-flex items-center rounded-full bg-blue-100 px-2 py-0.5 text-xs font-medium text-blue-800">
                                                <Users xmlns="http://www.w3.org/2000/svg" className="mr-1 h-3 w-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M22 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></Users>
                                                Covers {proposal.affectedPatientCount} Patients
                                            </span>
                                        )}
                                    </div>
